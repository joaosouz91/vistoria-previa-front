...
@Component({
    selector: 'app-relatorio-faturamento-consulta',
    templateUrl: './relatorio-faturamento-consulta.component.html'
})
export class RelatorioFaturamentoConsultaComponent implements OnInit {
